    ...
    <aside id="left-panel" class="left-panel">
        <nav class="navbar navbar-expand-sm navbar-default">
            ...
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="./">Marketplace Scraper</a>
                <a class="navbar-brand hidden" href="./">MS</a>
            </div>
            ...
            <div id="main-menu" class="main-menu collapse navbar-collapse">
                <ul class="nav navbar-nav">
                    ...
                    <li class="menu-item-has-children dropdown">
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"> <i class="menu-icon fa fa-th"></i>Master Data</a>
                        <ul class="sub-menu children dropdown-menu">
                            <li><i class="fa fa-users"></i><a href="<?php echo base_url('Users/') ?>">Users</a></li>
                            <li><i class="fa fa-building"></i><a href="<?php echo base_url('Marketplace/') ?>">Marketplace</a></li>
                            <li><i class="fa fa-puzzle-piece"></i><a href="<?php echo base_url('Kata_Baku/') ?>">Kata_Baku</a></li>
                            <li><i class="fa fa-puzzle-piece"></i><a href="<?php echo base_url('Kata_Tidak_Baku/') ?>">Kata_Tidak_Baku</a></li>
                        </ul>
                    </li>
                    <li class="menu-item-has-children dropdown">
                    ...
                    <li class="">
                        <a href="<?php echo base_url('Dataset/') ?>"> <i class="menu-icon fa fa-database"></i>Dataset </a>
                    </li>

                    <li class="">
                        <a href="<?php echo base_url('Training/') ?>"> <i class="menu-icon fa fa-dashboard"></i>Training </a>
                    </li>
                    <li class="menu-item-has-children dropdown">
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"> <i class="menu-icon fa fa-laptop"></i>SVM</a>
                        <ul class="sub-menu children dropdown-menu">
                ...
                <div class="col-sm-5">
                    <div class="user-area dropdown float-right">
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                            <img class="user-avatar rounded-circle" src="<?php echo base_url('storage/users/' . $this->session->userdata('userlogin')['gambar']) ?>" alt="User Avatar">
                        </a>
