        ...
        <div class="card">
            <div class="card-body">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-10">
                        <input type="text" name="kata_tidak_baku" class="form-control" placeholder="kata_tidak_baku" value="<?php echo set_value('kata_tidak_baku') ?>">
                ...
                <div class="form-group row">
                    ...
                    <?php foreach($this->db->get('kata_baku')->result() as $key => $value): ?>
                        <option value="<?php echo $value->id ?>"><?php echo $value->kata_baku ?></option>
